...
We will explore $ layers $ that actually **learn** something: $ layers $ declaring **weights** 
(recall the **weights** in [this article]({% post_url 2021-08-19-weights %})). 
But we will also explore some more basic $ layers $: $ layers $ with no **weights**. 

Let us begin with the $ Linear $ $ layer $. In order to dig deeper into this $ layer $, we will talk about 
...
In the [next article]({% post_url 2021-10-06-activation %}) we will continue exploring the other $ layers $ of our "Example".
