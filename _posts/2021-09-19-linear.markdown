...
$$ 
\begin{align}
L^{k}_1(X^{k}) &= W^{k, 1}_1 . X^{k}_1 + W^{k, 1}_2 . X^{k}_2 + W^{k, 1}_3 . X^{k}_3 + B^{k} \\
L^{k}_2(X^{k}) &= W^{k, 2}_1 . X^{k}_1 + W^{k, 2}_2 . X^{k}_2 + W^{k, 2}_3 . X^{k}_3 + B^{k}
\end{align}
$$ 
...
Note that we have one more **weight**: $ B^{k} $ that is used the same in $ L^{k}_1 $ and in $ L^{k}_2 $. 
...
\frac{\partial (W^{k, 1}_1 . X^{k}_1 + W^{k, 1}_2 . X^{k}_2 + W^{k, 1}_3 . X^{k}_3 + B^{k})}{\partial X^{k}_2} \\
                                          &= W^{k, 1}_2 
\end{align}
$$
...
\frac{\partial (W^{k, 1}_1 . X^{k}_1 + W^{k, 1}_2 . X^{k}_2 + W^{k, 1}_3 . X^{k}_3 + B^{k})}{\partial X^{k}_3} \\
                                          &= W^{k, 1}_3 
\end{align}
$$
...
\frac{\partial (W^{k, 1}_1 . X^{k}_1 + W^{k, 1}_2 . X^{k}_2 + W^{k, 1}_3 . X^{k}_3 + B^{k})}{\partial W^{k, 1}_1} \\
                                             &= X^{k}_1
\end{align}
$$
...
\frac{\partial (W^{k, 2}_1 . X^{k}_1 + W^{k, 2}_2 . X^{k}_2 + W^{k, 2}_3 . X^{k}_3 + B^{k})}{\partial W^{k, 2}_1} \\
                                             &= X^{k}_1
\end{align}
$$
...
$$ 
\delta b^{k} = \frac{\partial Loss}{\partial B^{k}}(o^{k-1})
$$
...
- $ B^{k} $ impacts $ L^{k}_1 $ which impacts the $ Loss $ function  
- $ B^{k} $ impacts $ L^{k}_2 $ which impacts the $ Loss $ function  

We add these 2 impacts, using the **chain rule**, to obtain the "impact" formula: 

$$ 
\delta b^{k} = \delta^{k+1}_1 * \frac{\partial L^{k}_1}{\partial B^{k}}(o^{k-1}) + 
\delta^{k+1}_2 * \frac{\partial L^{k}_2}{\partial B^{k}}(o^{k-1})
$$
...
$$ 
\begin{align}
\frac{\partial L^{k}_1}{\partial B^{k}} &= 
\frac{\partial (W^{k, 1}_1 . X^{k}_1 + W^{k, 1}_2 . X^{k}_2 + W^{k, 1}_3 . X^{k}_3 + B^{k})}{\partial B^{k}} \\
                                        &= 1
\end{align}
$$
...
$$ 
\frac{\partial L^{k}_1}{\partial B^{k}}(o^{k-1}) = 1
$$

We do the same to obtain: 

$$ 
\frac{\partial L^{k}_2}{\partial B^{k}}(o^{k-1}) = 1
$$

We finally assemble these two results in the "impact" formula:

$$ 
\boxed{\delta b^{k} = \delta^{k+1}_1 + \delta^{k+1}_2}
$$
