...
$$ 
w^2 = (\frac{1}{200}, -\frac{8 800}{11 600 000}, \frac{1}{5 800})
$$

When we evaluate $ L2 $ on $ o1 $ output from $ L1 $ we have:

$$ 
L2(o1, w^2) = w^2 * o1 = \frac{1}{200} * o^1_1 - \frac{8 800}{11 600 000} * o^1_2 + \frac{1}{5 800} * o^1_3
$$
...
$$ 
\boxed{\delta 3 = \delta 4 \text{ if } o2 > 0 \text{, else } 0}
$$

$$ 
\delta 2 = \delta 3 * (\frac{1}{200}, -\frac{8 800}{11 600 000}, \frac{1}{5 800})
$$
...
$$ 
\boxed{\delta 2 = \delta 3 . w2 \text{ with } w^2 = (\frac{1}{200}, -\frac{8 800}{11 600 000}, \frac{1}{5 800})}
$$
