...
We used the **learning flux** in order to compute the $ derivative $ functions of $ Loss $ according to these 
**weights**. In a side note, we remarked that we could merge both the **learning flux** and 
...
Please note here that as we are doing exactly the same as in the "Run the backward pass for the learning flux" 
paragraph, we could merge the two steps "backward pass for the learning flux" and 
...
These all computations needing the **learning flux** from the previous $ layers $ 
