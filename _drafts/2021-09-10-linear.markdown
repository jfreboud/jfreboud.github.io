...
<a id="linear-structure" class="anchor">
...
The interesting variable is: $ X^{k+1, 1} $. In the different figures it corresponds to $ o^{k}_1 $, 
...
Indeed we can look at the two figures [here](#linear-structure) to see that 
...
The interesting variable is: $ X^{k+1, 2} $. In the different figures it corresponds to $ o^{k}_2 $, 
its value during the current **backward pass**. As in the previous paragraph, 
every output of $ L^{k+1} $ uses $ X^{k+1, 2} $.
Indeed we can look at the last two figures [here](#linear-structure) to see that 
...
The interesting variable is: $ X^{k+1, 3} $. In the different figures it corresponds to $ o^{k}_3 $, 
its value during the current **backward pass**. As in the previous paragraph, 
