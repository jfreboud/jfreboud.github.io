...
\delta^{k+2, 2} * \frac{\partial L^{k+1, 3}}{X^{k+1, 2}}(o^k_3)
$$
...
The **neural structure** we have seen in the [previous paragraph](#example) is just another way to formalize the 
